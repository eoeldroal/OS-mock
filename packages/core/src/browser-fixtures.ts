...
export const BROWSER_BOOKMARKS: BrowserBookmark[] = [
  ...
  { id: "osworld", label: "Task Board", page: "explorer" },
...
export const BROWSER_HELP_TOPICS: BrowserHelpTopic[] = [
  {
    ...
    lines: [
      ...
      "Use the Task Board bookmark to return to the board quickly."
    ]
  },
  {
    id: "window-controls",
  ...
  },
  {
    ...
    lines: [
      "Representative desktop tasks often span browser, mail, terminal, and file workflows.",
    ...
    tasks: [
      {
        ...
        domain: "Thunderbird",
        title: "Capture the workspace reminder",
        instruction: "Open the Workspace notes message and copy its reminder into a note.",
