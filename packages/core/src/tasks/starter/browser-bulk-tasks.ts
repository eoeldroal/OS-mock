...
const HELP_BATCH: HelpTaskConfig[] = [
  {
    ...
    startState: "dock-heading-snapshot.txt is unopened in File Explorer while Firefox still shows Task Board.",
  ...
  },
  {
    ...
    startState: "dock-tail-block.txt is already open while Firefox still shows Task Board.",
  ...
  },
  {
    ...
    startState: "workflow-reminder-block-starter.txt is already open while Firefox still shows Task Board.",
...
const TASK_BATCH: ExplorerTaskConfig[] = [
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about Thunderbird summaries, copy the card heading into mail-bridge-heading.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about Thunderbird summaries, copy the coordinator line into mail-bridge-coordinator.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about Thunderbird summaries, copy the lead step into mail-bridge-lead-step.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about Thunderbird summaries, copy the final step into mail-bridge-finish-step.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about terminal capture, copy its domain tag into terminal-domain-tag.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about terminal capture, copy the coordinator line and domain tag into terminal-coordinator-block.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Workflow card about digesting help, copy its level label into help-digest-level.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the OS card about bringing back the editor, copy the card heading into restore-window-heading.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the OS card about clearing a blocking popup, copy the domain tag and level label into popup-domain-level.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the OS card about relaunching Firefox from the dock, copy the coordinator line into dock-relaunch-coordinator.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Chrome card about the help reminder, copy the coordinator line and domain tag into help-capture-coordinator-domain.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, open the Chrome card about bookmark note cleanup, copy the card heading and coordinator line into bookmark-cleanup-heading.txt, and save.",
