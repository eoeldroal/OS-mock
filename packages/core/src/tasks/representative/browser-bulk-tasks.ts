...
import type { PredicateId, TaskSpec, Viewport } from "../../types.js";
...
const HELP_BATCH: HelpTaskConfig[] = [
  ...
  },
  {
    ...
    startState: "window-bundle.txt is already open while Firefox still shows Task Board.",
...
const TASK_BATCH: ExplorerTaskConfig[] = [
  {
    ...
    instruction: "In Firefox Task Board, identify the Ops Desk card about Thunderbird summaries, copy the card heading into opsdesk-summary-heading.txt, and save.",
    ...
    preopen: true,
    start: workflowDistractorStart,
    family: "browser_compare_to_note"
  },
  {
    id: "browser_card_opsdesk_summary_coordinator_level",
    instruction: "In Firefox Task Board, identify the Ops Desk card about Thunderbird summaries, copy the coordinator line and level label into opsdesk-summary-level.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Infra Lab card about terminal capture, copy the card reference into terminal-reference.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Support Docs card about digesting help, copy the card heading into supportdocs-digest-heading.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Support Docs card about digesting help, copy its lead step and final step into supportdocs-digest-steps.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Desktop Team card about relaunching Firefox from the dock, copy the card heading into desktopteam-dock-heading.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Desktop Team card about relaunching Firefox from the dock, copy its level label into desktopteam-dock-level.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Research Board card that stays inside Firefox only, copy the card heading into research-board-only-heading.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Chrome card about the help reminder, copy its domain tag and coordinator line into help-capture-domain-coordinator.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Chrome card about bookmark note cleanup, copy the middle two steps into bookmark-cleanup-step-pair.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Mail Desk card about workspace notes, copy the coordinator line and level label into mock-notes-level.txt, and save.",
    ...
    objective: "Identify the workspace notes card, capture its coordinator plus level block, and save.",
    preopen: true,
    family: "browser_compare_to_note"
  },
  {
    id: "browser_card_task_pack_cross_app_heading",
    instruction: "In Firefox Task Board, identify the Mail Desk card that spans Thunderbird and Firefox together, copy the card heading into task-pack-cross-app-heading.txt, and save.",
  ...
  },
  {
    ...
    instruction: "In Firefox Task Board, identify the Mail Desk card about inbox triage, copy the coordinator line and final step into inbox-triage-followup.txt, and save.",
